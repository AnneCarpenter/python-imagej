...
def make_invoke_method(method, returns_value=False, doc=None, fn_post_process=None):
...
if __name__ == "__main__":
    ...
    classpath = os.pathsep.join([os.path.join(jar_dir, filename) for filename in os.listdir(jar_dir) if filename.endswith(".jar")])

    J.start_vm(class_path = classpath)
