...
class TestImagej2(unittest.TestCase):
    ...
    def test_02_03_module_info(self):
        ...
        for module_info in module_infos:
            ...
            if len(inputs) > 0:
                ...
                self.assertIsNotNone(
                    module_info.getInput(module_item.getName()))
                break
        else:
        ...
        for module_info in module_infos:
            ...
            if len(outputs) > 0:
                ...
                self.assertIsNotNone(
                    module_info.getOutput(module_item.getName()))
                break
        else:
    ...
    def test_06_01_get_mask_data(self):
        ...
        d2 = display_svc.createDisplay("Bar",
                                       ij2.create_dataset(self.context, image,
                                                          "Bar"))
    ...
    def test_09_08_check_stride(self):
        ...
        self.run_command(
            "net.imagej.plugins.commands.rotate.Rotate90DegreesLeft",
    ...
    def test_10_04_engine_factory_wrapper(self):
        ...
        factory.getMethodCallSyntax("myobject", "mymethod",
                                    ["param1", "param2"])
